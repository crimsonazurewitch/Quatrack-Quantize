...
function drawHits(hits,x,y)
    ...
    GC.printf(hits.perf+hits.perc+hits.marv,-140,0,600,'right')

    FONT.set(80)
    GC.setColor(.58,.65,.96)
    GC.printf(hits.good+hits.great,-140,100,600,'right')
    ...
    GC.printf(hitTexts[5],-45,27,600,'right')
    GC.print(hits.perf,565,27)
    GC.setColor(hitColors[4])
    GC.printf(hitTexts[4],-45,52,600,'right')
    GC.print(hits.perc,565,52)
    GC.setColor(hitColors[3])
    GC.printf(hitTexts[3],-45,77,600,'right')
    GC.print(hits.marv,565,77)

    GC.setColor(hitColors[2])
    GC.printf(hitTexts[2],-45,123,600,'right')
    GC.print(hits.great,565,123)
    GC.setColor(hitColors[1])
    GC.printf(hitTexts[1],-45,153,600,'right')
    GC.print(hits.good,565,153)

    GC.setColor(hitColors[0])
    GC.printf(hitTexts[0],-45,203,600,'right')
    GC.print(hits.bad,565,203)
    GC.setColor(hitColors[-1])
    GC.printf(hitTexts[-1],-45,233,600,'right')
    GC.print(hits.miss,565,233)
    GC.translate(-x,-y)
end

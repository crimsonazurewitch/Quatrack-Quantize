                ...
                for _,itemName in next,love.filesystem.getDirectoryItems(dirPath) do
                    if itemName:sub(-4)=='.qbp' then
                        ...
                        ins(mapList,{
                            ...
                            difficultyColor=
                                dText:sub(1,4)=='THEO' and COLOR.lG or
                                dText:sub(1,4)=='PROT' and COLOR.lY or
                                dText:sub(1,4)=='APPL' and COLOR.lR or
                                dText:sub(1,4)=='OPTI' and COLOR.lM or
                                dText:sub(1,4)=='QUAN' and COLOR.dL or
                                COLOR.T,
...
scene.widgetList={
    ...
    WIDGET.new{
        type='button_fill',
        pos={1,1},
        x=-120,y=-80,w=160,h=80,
        sound_release='back',
        fontSize=60,
        text=CHAR.icon.back,
        onClick=WIDGET.c_backScn()
    },
}
return scene
